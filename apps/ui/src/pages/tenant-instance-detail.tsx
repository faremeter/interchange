...
function resolveAgentRecipient(
  ...
  const local = first.email.split("@")[0];
  if (local && local.startsWith("ins_")) {
    return { instanceId: local, label: formatAddress(first) };
  }
  return null;
}
                ...
                getMessages(instanceId).map((msg, i) => {
                  ...
                  const agentRecipient =
                    isAssistantMail && msg.kind === "mail"
                      ...
                      : null;
                  const isInterAgentMail = agentRecipient !== null;
                  ...
                  return (
                    ...
                    >
                      {isInterAgentMail && agentRecipient !== null ? (
