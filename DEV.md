...
| `DB_STATEMENT_TIMEOUT_MS`            | hub (`apps/hub`)                             | 60000 (60s)                         | Positive integer milliseconds, up to 2147483647. Cancels SQL statements exceeding this duration, including lock waits.                               |
