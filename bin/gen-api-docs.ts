...
const app = createApp({
  ...
  // route metadata, not runtime services.
...
// The OpenAPI spec is generated by our own app — the shape is known and
// controlled. A full arktype validator for the OpenAPI schema object would
// be prohibitively large for a dev tooling script.
// eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion
